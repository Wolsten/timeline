...
class TimelineEntry {
    ...
    constructor(oxRange, dxRange, index, rawEntry, dataCategories = [], dataSubCategories = []) {
        // Save basic data
        ...
        // Set colours
        this.colour = rawEntry.colour ? rawEntry.colour : Utils.defaultColour(index)
        ...
        rawEntry.points.forEach(point => {
            const pt = new TimelinePoint(point, this.colour, this.categoryColour, this.subCategoryColour)
    ...
    static init(xRange, rawSeries, options, dataCategories, dataSubCategories) {
        ...
        const categoryGroups = TimelineEntry.groupSeries(rawSeries, 'category', dataCategories)
        const subCategoryGroups = TimelineEntry.groupSeries(rawSeries, 'sub-category', dataSubCategories)
        rawSeries = [
            ...rawSeries,
            ...categoryGroups,
            ...subCategoryGroups
        ...
        rawSeries.forEach((entry, index) => {
            series.push(new TimelineEntry(options.xRange, xRange, index, entry, dataCategories, dataSubCategories))
